            ...
            <div className="space-y-4 text-center">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-sm leading-relaxed text-muted-foreground">
                        Your account is pending administrator approval. You&apos;ll be able to sign in once your request
                        is approved.
                    </p>
                </div>
            </div>
...
async function createPendingWorkspaceMembership() {
...
export function AccessRequestForm() {
    ...
    const { mutate: signUpEmail, isPending } = useSignUpEmail(authClient, {
        ...
        onSuccess: async () => {
            try {
                await createPendingWorkspaceMembership();
            } catch {
                // The pending page will retry RBAC status checks after sign-in.
            }
