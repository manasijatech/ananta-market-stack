...
export const authFormInputClassName =
    `inline-flex h-10 items-center rounded-lg border border-border/80 bg-background/50 px-3.5 text-sm shadow-none before:!hidden has-aria-invalid:!ring-0 has-aria-invalid:!shadow-none dark:has-aria-invalid:!ring-0 has-focus-visible:has-aria-invalid:!ring-0 placeholder:text-muted-foreground/90 has-[input:focus-visible]:border-primary has-[input:focus-visible]:ring-[3px] has-[input:focus-visible]:ring-[var(--accent-glow)] has-[:disabled,:focus-visible,[aria-invalid]]:!shadow-none dark:bg-[var(--bg-elevated)]/50 ${authFormInputInnerClassName}`;
...
export const authFormInputGroupClassName =
    "h-10 items-center rounded-lg border border-border/80 bg-background/50 shadow-none before:!hidden has-[input[aria-invalid]]:!ring-0 has-[input[aria-invalid]]:!shadow-none dark:has-[input[aria-invalid]]:!ring-0 has-[input:focus-visible]:has-[input[aria-invalid]]:!ring-0 has-[input:focus-visible]:border-primary has-[input:focus-visible]:ring-[3px] has-[input:focus-visible]:ring-[var(--accent-glow)] dark:bg-[var(--bg-elevated)]/50 **:[input]:h-full **:[input]:min-h-0 **:[input]:border-0 **:[input]:bg-transparent **:[input]:px-3.5 **:[input]:py-0 **:[input]:text-sm **:[input]:leading-normal **:[input]:shadow-none **:[input]:ring-0 **:[input]:placeholder:text-muted-foreground/90 sm:**:[input]:h-full sm:**:[input]:leading-normal [&_[data-slot=input-group-addon]]:pe-2 [&_[data-slot=button]]:border-transparent [&_[data-slot=button]]:bg-transparent [&_[data-slot=button]]:shadow-none [&_[data-slot=button]]:hover:bg-black/5 [&_[data-slot=button]]:hover:text-foreground [&_[data-slot=button]]:focus-visible:ring-0 dark:[&_[data-slot=button]]:hover:bg-white/5";
