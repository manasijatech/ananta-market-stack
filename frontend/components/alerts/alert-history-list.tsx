            ...
            <section className="grid min-h-[120px] gap-3 min-[1024px]:pr-6">
                ...
                <div className="grid max-h-[420px] gap-3 overflow-y-auto pr-1">
                    {alertList.rows.map((item) => (
                        <div
                            className={cn(
                                "app-card-surface min-h-[120px] bg-card p-4",
                ...
                {showRuns ? (
                    <div className="grid max-h-[420px] gap-3 overflow-y-auto pr-1">
                        {runList.rows.map((item) => (
                            <div className="app-card-surface min-h-[120px] bg-card p-4" key={item.id}>
                    ...
                    <div className="app-card-surface type-help flex min-h-[120px] items-center bg-card p-4">
