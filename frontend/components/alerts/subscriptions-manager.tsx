...
export function SubscriptionsManager({
 ...
 <select className="h-10 border border-input bg-background px-3 text-sm" onChange={(event) => setAccountId(event.target.value)} value={accountId}>
 ...
 <textarea
 className="mt-3 min-h-[112px] w-full border border-input bg-background px-3 py-2 text-sm outline-none"
