  ...
  return (
    <section className="border-t border-border py-8">
      <div className="flex flex-col justify-between gap-4 min-[760px]:flex-row min-[760px]:items-start">
        <div>
          ...
          <div className="mt-4 flex flex-wrap gap-2 text-xs font-bold">
            <Badge className={sessionStatus.session_active ? "border-emerald-200 bg-emerald-50 text-emerald-700 dark:border-emerald-500/30 dark:bg-emerald-500/10 dark:text-emerald-200" : "border-amber-200 bg-amber-50 text-amber-700 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-200"} variant="outline">
      ...
      {"login_url" in sessionStatus && sessionStatus.login_url && !sessionStatus.session_active ? (
        <Button
          ...
          className={cn(
            "mt-5",
            shouldPulseLogin &&
              "relative isolate animate-bounce ring-2 ring-primary/55 ring-offset-1 ring-offset-background before:pointer-events-none before:absolute before:-inset-1 before:-z-10 before:rounded-md before:bg-primary/15 before:content-[''] before:animate-pulse"
          )}
        >
      ...
      {broker === "groww" && mode === "auto" && !sessionStatus.session_active ? (
        <div className="mt-5">
          <Button
            className="relative isolate animate-bounce ring-2 ring-primary/55 ring-offset-1 ring-offset-background before:pointer-events-none before:absolute before:-inset-1 before:-z-10 before:rounded-md before:bg-primary/15 before:content-[''] before:animate-pulse"
            disabled={isPending}
