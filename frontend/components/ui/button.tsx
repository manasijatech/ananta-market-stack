    ...
    "inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 border text-sm font-semibold whitespace-nowrap uppercase tracking-[0.08em] transition-colors duration-100 ease-out outline-none focus-visible:border-ring focus-visible:ring-0 disabled:cursor-not-allowed disabled:opacity-40 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 [&_svg]:shrink-0",
    {
        variants: {
            variant: {
                ...
                destructive:
                    "border-destructive bg-transparent text-destructive hover:bg-destructive/10 active:bg-destructive/15",
                outline:
                    "border-input bg-transparent text-foreground hover:border-primary hover:bg-[var(--accent-glow)] hover:text-primary active:bg-[var(--accent-subtle)]",
                secondary:
                    "border-border bg-secondary text-secondary-foreground hover:border-primary/60 hover:bg-[var(--bg-hover)] active:border-primary active:bg-[var(--accent-subtle)]",
