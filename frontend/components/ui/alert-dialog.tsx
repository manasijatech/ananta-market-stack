...
export function AlertDialogMedia({
  ...
  return (
    <div
      className={cn(
        "mx-auto flex size-12 items-center justify-center rounded-full bg-muted text-foreground [&_svg:not([class*='size-'])]:size-5",
        className,
      )}
...
export function AlertDialogCancel({
  ...
  Pick<ButtonProps, "variant" | "size">): React.ReactElement {
  return (
