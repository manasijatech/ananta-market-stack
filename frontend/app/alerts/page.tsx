  ...
  return (
    <Shell>
      ...
      <div className="mb-8 flex flex-wrap gap-3 text-sm font-semibold">
        <Link className="rounded-full border border-border px-3 py-1.5 hover:text-foreground" href="/alerts/workflows">
          Manage workflows
        </Link>
        <Link className="rounded-full border border-border px-3 py-1.5 hover:text-foreground" href="/alerts/templates">
          Browse templates
        </Link>
        <Link className="rounded-full border border-border px-3 py-1.5 hover:text-foreground" href="/alerts/subscriptions">
          Manage subscriptions
        </Link>
        <Link className="rounded-full border border-border px-3 py-1.5 hover:text-foreground" href="/alerts/stream-manager">
          Open stream manager
        </Link>
      </div>
