...
- The Alerts V2 condition-state/config normalization revision is `c4e9a7b2d1f6`.
- The current schema head is `d7a4f23c9e81`, which adds isolated Alert Workflow
  AI Chat preferences, sessions, durable runs, resumable events, and immutable
  workflow snapshots.
